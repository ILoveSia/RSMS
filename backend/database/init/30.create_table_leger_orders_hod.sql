...
CREATE TABLE public.ledger_orders_hod (
  ...
  ledger_orders_hod_field_type_cd varchar(2) NULL, -- 원장차수필드타입코드
	...
	CONSTRAINT ledger_orders_hod_pkey PRIMARY KEY (ledger_orders_hod_id)
);
